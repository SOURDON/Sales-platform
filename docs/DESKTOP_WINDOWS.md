...
1. Получите файл **`Fotografy_*_x64-setup.exe`** (от IT или из сборки CI).  
   С v1.0.44 установщик **~130 МБ**: внутри уже есть WebView2, интернет при установке не нужен.
...
| Установщик зависает на WebView2 | С v1.0.44 WebView2 встроен в `.exe` (offline). Если окно Microsoft не завершилось — перезапустите установщик от имени администратора |
