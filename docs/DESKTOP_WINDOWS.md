...
1. Получите файл **`Fotografy_*_x64-setup.exe`** (от IT или из сборки CI).  
   Установщик **~15–25 МБ**; при первой установке может скачать WebView2 Runtime (нужен интернет, обычно один раз).
...
| Установщик зависает на WebView2 | Нужен интернет при установке. Перезапустите установщик от имени администратора или установите [Evergreen WebView2](https://developer.microsoft.com/microsoft-edge/webview2/) вручную |
